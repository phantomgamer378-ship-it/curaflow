...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Check a live queue' link to open the live queue page.
        ...
        # Assert: Verify the current token is not displayed
        assert False, "Expected: Verify the current token is not displayed (could not be verified on the page)"
